  ...
  _createClass(pieChart, [{
    ...
    value: function draw() {
      ...
      this.chartDatas.map(function (item, i) {
        ...
        _this6.context.fillText("".concat(item.title), _this6.width * 0.06 + tagW, _this6.height * 0.2 + tagH * i * 2.5 + tagH * 0.5);
        ...
        _this6.AngleList.push(endAngle);
        ...
        _this6.context.rect(_this6.width * 0.51, _this6.height * 0.53, _this6.size * 0.27, _this6.size * 0.14);
...
var scatterChart = function () {
  ...
  _createClass(scatterChart, [{
    ...
    value: function draw() {
      ...
      var everySymbolSize = (maxSymbolSize - minSymbolSize) / (maxZ - minZ);
